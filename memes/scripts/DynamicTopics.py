...
def compute_coherence_values(dictionary, corpus, texts, start, step):
    ...
    model = New_model(corpus, num_topics, dictionary, 100, 50, 50, 'auto', True)    
...
def New_model(corpus, num_topics, dictionary, random_state, chunksize, passes, alpha, per_word_topics):
